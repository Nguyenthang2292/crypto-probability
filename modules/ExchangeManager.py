...
try:
    ...
    DEFAULT_EXCHANGES = ["binance", "kraken", "kucoin", "gate", "okx", "bybit", "mexc", "huobi"]
...
class AuthenticatedExchangeManager:
    ...
    def connect_to_exchange_with_credentials(self, exchange_id: str, 
                                           api_key: Optional[str] = None,
                                           api_secret: Optional[str] = None,
                                           testnet: Optional[bool] = None,
                                           contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def set_exchange_credentials(self, exchange_id: str, api_key: str, api_secret: str):
        ...
        keys_to_remove = [k for k in self._authenticated_exchanges.keys() if k.startswith(f"{exchange_id}_")]
    ...
    def connect_to_binance_with_credentials(self) -> ccxt.Exchange:
        ...
        DEPRECATED: Use connect_to_exchange_with_credentials('binance') instead.
    ...
    def connect_to_kraken_with_credentials(self, api_key: Optional[str] = None,
                                          api_secret: Optional[str] = None,
                                          testnet: Optional[bool] = None,
                                          contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def connect_to_kucoin_with_credentials(self, api_key: Optional[str] = None,
                                         api_secret: Optional[str] = None,
                                         testnet: Optional[bool] = None,
                                         contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def connect_to_gate_with_credentials(self, api_key: Optional[str] = None,
                                        api_secret: Optional[str] = None,
                                        testnet: Optional[bool] = None,
                                        contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def connect_to_okx_with_credentials(self, api_key: Optional[str] = None,
                                       api_secret: Optional[str] = None,
                                       testnet: Optional[bool] = None,
                                       contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def connect_to_bybit_with_credentials(self, api_key: Optional[str] = None,
                                         api_secret: Optional[str] = None,
                                         testnet: Optional[bool] = None,
                                         contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def connect_to_mexc_with_credentials(self, api_key: Optional[str] = None,
                                       api_secret: Optional[str] = None,
                                       testnet: Optional[bool] = None,
                                       contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
    ...
    def connect_to_huobi_with_credentials(self, api_key: Optional[str] = None,
                                         api_secret: Optional[str] = None,
                                         testnet: Optional[bool] = None,
                                         contract_type: Optional[str] = None) -> ccxt.Exchange:
        """
...
class ExchangeManager:
    ...
    def get_binance_exchange_instance(self) -> ccxt.Exchange:
        """
        Get authenticated Binance exchange instance (REQUIRES credentials).
        
        DEPRECATED: Use self.authenticated.connect_to_binance_with_credentials() instead.
        Kept for backward compatibility.
        """
        return self.authenticated.connect_to_binance_with_credentials()
    
    def get_exchange_instance(self, exchange_id: str) -> ccxt.Exchange:
        """
        Get public exchange instance for OHLCV data (NO credentials required).
        
        DEPRECATED: Use self.public.connect_to_exchange_with_no_credentials(exchange_id) instead.
        Kept for backward compatibility.
        """
        return self.public.connect_to_exchange_with_no_credentials(exchange_id)
    
    def throttled_call(self, func, *args, **kwargs):
        """
        Throttled call using authenticated manager's rate limiter.
        
        DEPRECATED: Use self.authenticated.throttled_call() or self.public.throttled_call() instead.
        Kept for backward compatibility.
        """
        return self.authenticated.throttled_call(func, *args, **kwargs)
